...
export const CartProvider = ({children}) => {
    ...
    const add_to_cart_audio = new Audio(`${process.env.PUBLIC_URL}/assets/sounds/buttons_sounds/add_to_cart.mp3`)

    const eliminate_audio = new Audio(`${process.env.PUBLIC_URL}/assets/sounds/buttons_sounds/eliminate.mp3`)
